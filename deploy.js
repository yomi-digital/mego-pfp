...
async function deploy() {
    try {
        ...
        if (
            ...
            child_process.execSync('sudo PROVIDER="' + configs.provider + '" MNEMONIC="' + configs.owner_mnemonic + '" MEGO_ADDRESS="' + configs.mego + '" PFP_ADDRESS="' + configs.pfp + '" GATE="' + configs.gate + '" CONFIG="' + './configs/' + argv._ + '.json' + '" truffle deploy --network ' + configs.network + ' --reset', { stdio: 'inherit' })
